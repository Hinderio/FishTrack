...
window._tournaments = tournaments;
...
window._tournaments = tournaments;delete e.target.dataset.editingId}else state.tournaments.push(tournament);activeTournamentId=tournament.id;persist();
